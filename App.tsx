...
import { ShieldCheckIcon, InboxIcon, ExclamationTriangleIcon, PlusIcon, ArrowPathIcon, BeakerIcon } from './components/icons/Icons';
                ...
                <nav className="w-64 bg-gray-800 p-4 flex flex-col justify-between">
                    <div>
                        ...
                        <ul>
                            ...
                            <NavItem to="/sandbox" icon={<BeakerIcon className="h-5 w-5" />} text="Sandbox" />
                        </ul>
                        <div className="mt-8">
                             <button
